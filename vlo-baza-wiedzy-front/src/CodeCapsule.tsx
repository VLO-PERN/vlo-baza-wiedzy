...
const CodeCapsule = (props: any) => {
    ...
    const [editorValue, setEditorValue] = useState<string>(id ? id : (props.lang === "html" ? defaultValues.html : defaultValues.js)); // TS bullshit
    const copyLinkToClipboard = () => {
        const link = `${window.location.origin}/capsule/${props.lang}/${encodeURI(editorValue)}`;
