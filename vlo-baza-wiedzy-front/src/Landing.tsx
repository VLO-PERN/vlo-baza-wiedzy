                ...
                <CategoryWrapper id="bottom">
                    ...
                    {!categoriesAreLoading ?
                        ...
                        <CategoryContainer>
                            ...
                            <LandingCategoryCard style={{margin: "15px"}} key={index} id={item["id_category"]} onClick={(id: number) => {history.push(`/category/${id}`)}} name={item["category_name"]} img={item["picture_url"]} />
                        )}
                        </CategoryContainer>
                        </CategoryFlex>
                        : <CenterRelative>
